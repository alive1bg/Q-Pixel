...
Config.DeliveryMinPayout = 500 -- Minimum Payout of the item
...
Config.JobsList = {
    [1] = {
        ...
        event = "kevin-banktrucks:client:StartDelivery",
        minCops = 0,--- Amount of cops to do the delivery
    },
    [2] = {
        bank = true,
        ...
        icon = "fas fa-truck-moving",
        busyicon = "fas fa-xmark",
        event = "kevin-banktrucks:client:GotAccess",
        minCops = 0,
    },
}
