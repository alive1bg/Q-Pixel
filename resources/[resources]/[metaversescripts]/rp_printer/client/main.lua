...
RegisterNUICallback('CreateDocument', function(data, cb)
    TriggerServerEvent('qb-printer:server:CreateDocument', data.url)
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        local PrinterObject = GetClosestObjectOfType(pos.x, pos.y, pos.z, 2.5, GetHashKey("prop_printer_02"), false, false, false)
