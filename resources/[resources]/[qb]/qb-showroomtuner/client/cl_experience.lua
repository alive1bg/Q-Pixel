...
function openShowroom(showroom)
  ...
  Wait(250)
  -- exports["qb-showroomtuner"]:hideInteraction()
...
RegisterNUICallback("qb-showroomtuner:application-closed", function(data, cb)
...
RegisterNUICallback("qb-showroomtuner:showroomChangeCar", function(data, cb)
...
AddEventHandler("qb-showroomtuner:enterExperience", function()
  openShowroom("pdm")
...
CreateThread(function()
  exports['qb-target']:AddCircleZone("showroomtuner", vector3(131.15, -3007.22, 7.04), 0.25, {
    ...
    options = {
        {
            event = "qb-showroomtuner:enterExperience",
            icon = "fas fa-car",
            label = "Tuner Catalog"
        },
    },
