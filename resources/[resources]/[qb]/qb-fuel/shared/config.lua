...
Config.GasStations = { -- gas station polyzones
    ...
    [28] = { 
        zones = {
            vector2(489.12353515625, -988.26446533203),
            vector2(489.13159179688, -974.91857910156),
            vector2(471.89880371094, -974.91497802734),
            vector2(472.65441894531, -988.48309326172),
        },
        minz = 39.006652832031,
        maxz = 43.006771087646,
    },
    [29] = { 
        zones = {
            vector2(325.64364624023, -1464.3353271484),
			vector2(299.55029296875, -1442.4735107422),
			vector2(288.84606933594, -1455.2808837891),
			vector2(314.89797973633, -1477.12890625),			
        },
        minz = 44.509502410889,
  		maxz = 50.509532928467,
    },
    [30] = { 
        zones = {
            vector2(343.24130249023, -578.44488525391),
			vector2(338.40420532227, -591.13781738281),
			vector2(351.56024169922, -602.39721679688),
			vector2(363.5475769043, -593.17150878906),
			vector2(360.47259521484, -577.98516845703),			
        },
		minz = 70.68,
        maxz = 80.08,
    },
    [31] = { 
        zones = {
            vector2(-789.41784667969, -1211.966796875),
			vector2(-772.87030029297, -1192.4020996094),
			vector2(-793.12213134766, -1175.3173828125),
			vector2(-809.41186523438, -1195.5850830078),			
        },
        minz = 50.147064208984,
  		maxz = 60.147094726562,
    },
    [32] = { 
        zones = {
            vector2(325.64364624023, -1464.3353271484),
    ...
    [33] = { 
        zones = {
            vector2(-477.73483276367, 6006.767578125),
			vector2(-492.84866333008, 5991.7006835938),
			vector2(-472.35556030273, 5971.2109375),
			vector2(-457.26956176758, 5986.3291015625),			
        },
        minz = 25.340377807617,
  		maxz = 36.340410232544,
    },
    [34] = { 
        zones = {
            vector2(1826.365234375, 3640.8374023438),
			vector2(1867.4510498047, 3664.7443847656),
			vector2(1880.9357910156, 3644.9265136719),
			vector2(1841.4526367188, 3620.625),			
        },
