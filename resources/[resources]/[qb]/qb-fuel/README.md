![Project Sloth GitHub Project qb-fuel Banner](https://user-images.githubusercontent.com/91661118/169398756-5c1a49b8-e21c-4a06-baa6-7fcc793c34e3.png)
...
### Step 1:
Go ahead and start by dragging and dropping qb-fuel into your designated resources folder.
...
### Step 2:
Open your entire resources folder with Visual Studio Code (or whichever program you use) and replace all exsiting exports titled "qb-fuel" with "qb-fuel" instead. 

**If you have the previous resource "lj-fuel" do the same thing and replace that with "qb-fuel" or just get this newer version to avoid any conflictions or confusion.**
...
#### Some features to mention within this qb-fuel:
...
Here's a few showcased examples while using qb-fuel.
