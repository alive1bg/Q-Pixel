...
Config.Items = {
	...
	slots = 11,
	items = {
		[1] = { name = "sugar", price = 5, amount = 50, info = {}, type = "item", slot = 1, },
		[2] = { name = "flour", price = 5, amount = 50, info = {}, type = "item", slot = 2, },
		[3] = { name = "nori", price = 5, amount = 50, info = {}, type = "item", slot = 3, },
		[4] = { name = "tofu", price = 5, amount = 50, info = {}, type = "item", slot = 4, },
		[5] = { name = "onion", price = 5, amount = 50, info = {}, type = "item", slot = 5, },
		[6] = { name = "boba", price = 5, amount = 50, info = {}, type = "item", slot = 6, },
		[7] = { name = "mint", price = 5, amount = 50, info = {}, type = "item", slot = 7, },
		[8] = { name = "orange", price = 5, amount = 50, info = {}, type = "item", slot = 8, },
		[9] = { name = "strawberry", price = 5, amount = 50, info = {}, type = "item", slot = 9, },
		[10] = { name = "blueberry", price = 5, amount = 50, info = {}, type = "item", slot = 10, },
		[11] = { name = "milk", price = 7, amount = 50, info = {}, type = "item", slot = 11, },
		[12] = { name = "rice", price = 10, amount = 50, info = {}, type = "item", slot = 12, },
		[13] = { name = "sake", price = 20, amount = 50, info = {}, type = "item", slot = 13, },
		[14] = { name = "noodles", price = 15, amount = 50, info = {}, type = "item", slot = 14, },
	}
}
