...
setupContext = function()
    ...
    barMenu = {
        ...
        },
        {
            ...
            txt = t['browseDesc'],
            params = {
                event = "qb-medusa:Client:barMenu",
            }
        },
    }
    ...
    drinks = { -- read below on how to add more drinks
        ...
        },
        {
            ...
            params = {
                event = "qb-medusa:Client:purchaseDrink",
                args = {
    ...
    for k, v in pairs(settings) do
        ...
        exports['qb-target']:AddTargetModel(settings[k]['barSettings'].hash, {
            options = {
                {
                    event = "qb-medusa:Client:accessBarMenu",
        ...
        exports['qb-target']:AddTargetModel(settings[k]['bossSettings'].hash, {
            options = {
                {
                    event = "qb-medusa:Client:employeeManagement",
                    icon = "fas fa-sack-dollar",
