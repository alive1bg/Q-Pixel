...
RegisterNetEvent('hospital:server:SendToBed', function(bedId, isRevive)
	...
	Player.Functions.RemoveMoney("bank", Config.BillCost , "Pillbox")
...
RegisterServerEvent('custom_ambulance:requestCPR')
AddEventHandler('custom_ambulance:requestCPR', function(target, playerheading, playerCoords, playerlocation)
    print(target)
    TriggerClientEvent("custom_ambulance:playCPR", target, playerheading, playerCoords, playerlocation)
end)
