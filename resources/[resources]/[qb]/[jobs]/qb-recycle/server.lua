...
RegisterServerEvent("qb-recycle:getrecyclablematerial", function()
    local src = source
...
RegisterServerEvent("qb-recycle:TradeItems", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	local randItem = ""
	local amount = 0
...
RegisterServerEvent("qb-recycle:Selling:All", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local payment = 0
...
RegisterNetEvent("qb-recycle:Selling:Mat", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('qb-recycle:Dumpsters:Reward', function()
    local src = source 
    local Player = QBCore.Functions.GetPlayer(src)
