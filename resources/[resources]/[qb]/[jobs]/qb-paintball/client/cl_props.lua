...
AddEventHandler("np-props:attachProp", function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex)
  attachProp(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex)
end)

AddEventHandler("qb-weapons:server:Weapons", function()
  removeAttachedProp()
end)