...
function DisplayMenu(state, slider1, slider2, slider3, slider4, slider5, slider6, slider7, slider8, slider9, slider10, startPos)
    if state then
            ...
            {
                {
                    ...
                    items = 
                    {
                        {name = "w_width", type_1 = "normal", label_1 = "All Wheels Width", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider1, sliderStartPos = startPos[1]},
                        {name = "w_size", type_1 = "normal", label_1 = "All Wheels Size", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider2, sliderStartPos = startPos[2]},
                        {name = "w_fl", type_1 = "normal", label_1 = "Wheel Front Left Offset", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider3, sliderStartPos = startPos[3]},
                        {name = "w_fr", type_1 = "normal", label_1 = "Wheel Front Right Offset", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider4, sliderStartPos = startPos[4]},
                        {name = "w_rl", type_1 = "normal", label_1 = "Wheel Rear Left Offset", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider5, sliderStartPos = startPos[5]},
                        {name = "w_rr", type_1 = "normal", label_1 = "Wheel Rear Right Offset", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider6, sliderStartPos = startPos[6]},
                        {name = "w_flro", type_1 = "normal", label_1 = "Wheel Front Left Camber", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider7, sliderStartPos = startPos[7]},
                        {name = "w_frro", type_1 = "normal", label_1 = "Wheel Front Right Camber", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider8, sliderStartPos = startPos[8]},
                        {name = "w_rlro", type_1 = "normal", label_1 = "Wheel Rear Left Camber", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider9, sliderStartPos = startPos[9]},
                        {name = "w_rrro", type_1 = "normal", label_1 = "Wheel Rear Right Camber", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider10, sliderStartPos = startPos[10]}
                    }
                },
                {
