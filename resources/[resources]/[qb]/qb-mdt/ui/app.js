...
{/* <div class="bulletin-id">ID: ${value.id}</div> */}
  window.addEventListener("message", function (event) {
    ...
    if (eventData.type == "show") {
      $.post(`https://${GetParentResourceName()}/getBlackoutState`, JSON.stringify({})); // This line is added
    ...
    /* } else if (eventData.type == "bulletin") {
      ...
      $(".vehicle-tags")
        ...
        .removeClass("green-tag")
        .addClass("red-tag");
    } else if (eventData.type == "getBlackoutState") {
      if(eventData.data) {
        $(".cams-item").hide();
        $(".cams-blackout").show();
      } else {
...
function fidgetSpinner(page) {
  ...
  if (page == ".cams-page-container") {
    $.post(`https://${GetParentResourceName()}/getBlackoutState`, JSON.stringify({}));
  }
  setTimeout(() => {
