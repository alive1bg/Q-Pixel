...
CreateThread(function()
    exports["qb-target"]:AddBoxZone("chemmenu", vector3(3535.66, 3661.69, 28.12), 1.65, 2.4, {
        ...
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:chemicalmenu",
                icon = "fas fa-vials",
    ...
    exports["qb-target"]:AddBoxZone("weedproces", vector3(2328.53, 2570.99, 46.61), 2.5, 2.5, {
        ...
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:processWeed",
                icon = "fas fa-envira",
	...
	exports["qb-target"]:AddBoxZone("heroinproces", vector3(1384.9, -2080.61, 52.21), 2.5, 2.5, {
        ...
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:processHeroin",
                icon = "fas fa-envira",
    ...
    exports['qb-target']:AddBoxZone("thychloride", vector3(-679.77, 5800.7, 17.33), 1, 1, {
	   ...
	   options = {
			{
				type = "client",
				event = "qb-drugprocessing:processingThiChlo",
    ...
    exports['qb-target']:AddBoxZone("heroinproc", vector3(1413.7, -2041.77, 52.0), 1, 1, {
	    ...
	    options = {
			{
				type = "client",
				event = "qb-drugprocessing:ProcessPoppy",
				icon = "fas fa-leaf",
...
CreateThread(function()
    exports['qb-target']:AddTargetModel("mw_coke_plant", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:pickCocaLeaves",
                icon = "fas fa-leaf",
    ...
    exports['qb-target']:AddTargetModel("prop_plant_01b", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:pickHeroin",
                icon = "fas fa-leaf",
    ...
    exports['qb-target']:AddTargetModel("mw_weed_plant", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:pickWeed",
                icon = "fas fa-envira",
    ...
    exports['qb-target']:AddTargetModel("mw_sodium_barrel", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:pickSodium",
                icon = "fas fa-dna",
    ...
    exports['qb-target']:AddTargetModel("mw_sulfuric_barrel", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:pickSulfuric",
    ...
    exports['qb-target']:AddTargetModel("mw_chemical_barrel", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:pickChemicals",
    ...
    exports['qb-target']:AddTargetModel("mw_hydro_barrel", {
        options = {
            {
                type = "client",
                event = "qb-drugprocessing:client:hydrochloricacid",
                icon = "fas fa-radiation",
