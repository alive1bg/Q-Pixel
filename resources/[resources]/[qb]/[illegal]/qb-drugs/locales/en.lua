local Translations = {
    ...
    info = {
        ...
        drug_offer = "[~g~E~w~] %{bags}x %{drugLabel} for $%{randomPrice}? / [~g~G~w~] Decline offer",
        pick_up_button = "[~g~E~w~] Pick up",
        knock_button = "[~g~E~w~] Knock",
        grandma_man_button = "[~g~E~w~] Buy / [~g~G~w~] Help your guy ($5000)",
        other_dealers_button = "[~g~E~w~] Buy / [~g~G~w~] Start a mission",
        ...
        grandma_man_knock_message = "Hello my child, what can I do for you?",
