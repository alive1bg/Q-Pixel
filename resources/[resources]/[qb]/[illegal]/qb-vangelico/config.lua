...
Config.QBDoorID = 16 -- Enter the Door ID only if you're using qb-doorlock
...
Config.WhitelistedWeapons = {
    ...
    [GetHashKey('weapon_flamethrower')] = {
        ['timeOut'] = 12000
    },
    ...
    [GetHashKey('weapon_m14')] = {
        ['timeOut'] = 12000
    },
    [GetHashKey('weapon_dragunov')] = {
        ['timeOut'] = 12000
    },
    [GetHashKey('weapon_g22')] = {
        ['timeOut'] = 12000
    },
