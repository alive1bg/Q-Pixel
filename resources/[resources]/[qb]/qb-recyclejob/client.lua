...
CreateThread(function()
	...
	--Dumpster Third Eye -- not using, using a better dumpster dive
...
RegisterNetEvent('jim-recycle:Selling:Menu', function()
    exports['qb-menu']:openMenu({
		...
		{ header = QBCore.Shared.Items["cloth"].label, params = { event = "jim-recycle:SellAnim", args = 'cloth' } },
		{ header = QBCore.Shared.Items["gascan"].label, params = { event = "jim-recycle:SellAnim", args = 'gascan' } },
...
-- RegisterNetEvent('jim-recycle:Dumpsters:Search') -- not using
