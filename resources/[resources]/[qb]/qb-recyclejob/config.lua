...
Config.Locations =  {
	...
	['BottleBank'] = { name = "Bottle Bank", location = vector3(757.06, -1399.68, 26.57-1.0), heading = 178.1, blipTrue = false, Sprite = 642, Scale = 0.8, Colour = 2,}, -- The location where you enter the mine 
}
...
Config.Prices = {
	...
	['cloth'] = { name = 'cloth', amount = 5 },
	['gascan'] = { name = 'gascan', amount = 12 },
	['aluminum'] = { name = 'aluminium', amount = 10 },
	['bottle'] = { name = 'bottle', amount = 5 },
	['can'] = { name = 'bottle', amount = 5 },
}

Config.DumpItems = { -- not using this, commented out 3rd eye for this , have a better one
