...
-- show blips to naughty places for admins ease using /shownaughtyblips
local blipsadmin = {
    {title="Weed", colour=1, id=140, coords = vector3(99.99, 99.99, 99.99)},
    {title="Coke", colour=1, id=140, coords = vector3(99.99, 99.99, 99.99)},
    {title="Meth", colour=1, id=140, coords = vector3(99.99, 99.99, 99.99)},
    {title="Sell Contraband", colour=1, id=140, coords = vector3(-279.39, 2206.07, 129.84)},
    
  }

local state = false
 RegisterNetEvent('qb-admin:client:ToggleBlipAdmin', function()
    state = not state
      for _, info in pairs(blipsadmin) do
        if state then
