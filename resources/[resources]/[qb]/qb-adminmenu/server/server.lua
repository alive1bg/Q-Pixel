...
function OpenMenu(name)
    ...
    oldPed = GetPlayerPed(-1) --GetCurrentPed() i replaced this commented out shit
...
QBCore.Commands.Add('shownaughtyblips', ("Show/Hide Blip secret (Admin Only))"), {}, false, function(source)
    local src = source
    TriggerClientEvent('qb-admin:client:ToggleBlipAdmin', src)
end, 'admin')
