...
RegisterServerEvent('qb-adminmenu:server:SpawnItem')
AddEventHandler('qb-adminmenu:server:SpawnItem', function(ItemName, ItemAmount)
  local src = source                                            
...
RegisterServerEvent('qb-adminmenu:server:Csay')
AddEventHandler('qb-adminmenu:server:Csay', function(msg)
  local src = source                                            
...
RegisterServerEvent('qb-adminmenu:server:GetCoords')
AddEventHandler('qb-adminmenu:server:GetCoords', function(target, toggle)
  local src = source                                            
  if CoreName.Functions.HasPermission(src, 'admin') or IsPlayerAceAllowed(src, 'command') then
    ...
    TriggerClientEvent("qb-adminmenu:client:attach", source, tSrc, toggle)
    TriggerClientEvent("qb-adminmenu:client:sendCoords", source, playerCoords)
  end
end)


RegisterServerEvent('qb-adminmenu:server:bringPlayer')
AddEventHandler('qb-adminmenu:server:bringPlayer', function(target , pos)
  local src = source                                            
  if CoreName.Functions.HasPermission(src, 'admin') or IsPlayerAceAllowed(src, 'command') then
    TriggerClientEvent('qb-adminmenu:client:bringPlayer', tonumber(target),  pos)
...
RegisterServerEvent('qb-adminmenu:server:GiveCash')
AddEventHandler('qb-adminmenu:server:GiveCash', function(reciever, amount)
  local src = source          
  if CoreName.Functions.HasPermission(src, 'admin') or IsPlayerAceAllowed(src, 'command') then
...
RegisterNetEvent("qb-adminmenu:server:DropPlayer")
AddEventHandler("qb-adminmenu:server:DropPlayer", function(target, pReason)
  local src = source                                            
  if CoreName.Functions.HasPermission(src, 'admin') or IsPlayerAceAllowed(src, 'command') then
...
RegisterNetEvent("qb-adminmenu:server:setFav")
AddEventHandler("qb-adminmenu:server:setFav", function(data)
  local src = source                                            
  if CoreName.Functions.HasPermission(src, 'admin') or IsPlayerAceAllowed(src, 'command') then
    local Player = CoreName.Functions.GetPlayer(source)
...
AddEventHandler('ethicalpixel-admin:GetPlayersForBlips', function()
  ...
  if CoreName.Functions.HasPermission(src, 'admin') or IsPlayerAceAllowed(src, 'command') then
    ...
    TriggerClientEvent('qb-adminmenu:client:client:ShowBlips', src, players)  
  end
