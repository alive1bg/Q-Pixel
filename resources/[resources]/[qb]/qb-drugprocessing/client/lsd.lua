...
local function Processlsd()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugprocessing:Processlsd')
...
local function Processthionylchloride()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugprocessing:processThionylChloride')
...
RegisterNetEvent('qb-drugprocessing:processingThiChlo', function()
