...
local function installing_gunrack()
     ...
     QBCore.Functions.Progressbar("keep_gunrack_install", Lang:t('progressbar.installing_gun_rack'), duration, false,
          ...
          TriggerServerEvent('qb-gunrack:server:create_gunrack', plate)
     end)
end
...
RegisterNetEvent('qb-gunrack:client:start_installing_gunrack', function()
...
RegisterNetEvent("qb-gunrack:client:open_gunrack", function(plate)
...
AddEventHandler("qb-gunrack:client:open_gunrack_menu", function()
     local player_ped = PlayerPedId()
     local veh = nil
     ...
     TriggerServerEvent('qb-gunrack:server:open_gunrack', plate)
end)
...
if Config.gunrack.use_keys_to_unlock_gunrack then
     ...
     RegisterNetEvent('qb-gunrack:client:cut_key', function()
          ...
          if inputData then
               ...
               TriggerServerEvent('qb-gunrack:server:start_cut_key', inputData.PLATE)
          end
     end)

     RegisterNetEvent('qb-gunrack:client:keycuttingmachine_animation', function(plate)
          QBCore.Functions.Progressbar("keep_gunrack_keycuttingmachine", Lang:t('progressbar.cutting_key'),
               ...
               TriggerServerEvent('qb-gunrack:server:cut_key', plate)
          end)
     end)
end
