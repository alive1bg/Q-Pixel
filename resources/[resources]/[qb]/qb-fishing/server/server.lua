...
QBCore.Functions.CreateUseableItem("fishingloot", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		SetTimeout(1000, function()
			Player.Functions.AddItem('fishingkey', 1, nil) 
			TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['fishingkey'], "add", 1)

			Player.Functions.AddItem(Config.smallLootboxReward, 1, nil) 
...
QBCore.Functions.CreateUseableItem("fishtacklebox", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		SetTimeout(1250, function()
			Player.Functions.AddItem('pearlscard', 1, nil) 
...
RegisterNetEvent("fishing:server:addTackleBox", function()
	...
	SetTimeout(1000, function()
		Player.Functions.AddItem('fishtacklebox', 1, nil) 
    ...
    if itemFound then
        for i = 1, itemCount, 1 do
			...
			elseif luck >= 95 and luck <= 100 then
				Player.Functions.AddItem('fishinglootbig', 1, nil)
			...
			elseif luck >= 75 and luck <= 80 then
				...
				Player.Functions.AddItem('stingray1', 1, nil, info)
				TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['stingray1'], "add", 1)
			...
			elseif luck >= 65 and luck <= 70 then
				Player.Functions.AddItem('fishingboot', 1, nil)
			...
			elseif luck >= 55 and luck <= 60 then
				Player.Functions.AddItem('fishingloot', 1, nil)
			...
			elseif luck >= 45 and luck <= 50 then
				Player.Functions.AddItem('fishingtin', 1, nil)
