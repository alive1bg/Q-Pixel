...
QBCore.Functions.CreateCallback("cn-spawn:createCharacter", function(source,cb,args)
    local src = source
...
QBCore.Functions.CreateCallback("cn-spawn:deleteCharacter", function(source,cb,args)
    QBCore.Player.DeleteCharacter(source, args)
    cb(true)
end)

QBCore.Functions.CreateCallback("cn-spawn:fetchPlayerCharacters", function(source,cb)
...
QBCore.Functions.CreateCallback("cn-spawn:selectCharacter", function(source,cb, args)
    local src = source
